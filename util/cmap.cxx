...
int main() {
  ...
  std::cout << "//\n";
  std::cout << "// DO NOT EDIT THIS FILE !\n";
  std::cout << "//\n";
  std::cout << "// This file must be generated by \"util/cmap.cxx\".\n";
  std::cout << "// See instructions in this file.\n";
  std::cout << "//\n";
  std::cout << "// Copyright 1998-" << year << " by Bill Spitzak and others.\n";
  std::cout << "// Copyright " << year << " by GermanAizek\n";
  std::cout << "//\n";
  std::cout << "// This library is free software. Distribution and use rights are outlined in\n";
  std::cout << "// the file \"COPYING\" which should have been included with this file.  If this\n";
  std::cout << "// file is missing or damaged, see the license at:\n";
  std::cout << "//\n";
  std::cout << "//     https://www.fltk.org/COPYING.php\n";
  std::cout << "//\n";
  std::cout << "// Please see the following page on how to report bugs and issues:\n";
  std::cout << "//\n";
  std::cout << "//     https://www.fltk.org/bugs.php\n";
  std::cout << "//\n";

  // write color map values

  for (i = 0; i < 256; i++) {
    std::cout << "    0x" << std::hex << std::setfill('0') << std::setw(2) << cmap[i][0] << std::setw(2) << cmap[i][1] << std::setw(2) << cmap[i][2] << "00" << std::dec;
    if (i < 255)
  ...
  std::cout << "//\n";
  std::cout << "// End of src/fl_cmap.h - generated by util/cmap.cxx\n";
  std::cout << "//\n";
