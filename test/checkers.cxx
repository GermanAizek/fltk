...
Fl_Menu_Item menu[] = {
  ...
  {.text = "Undo", .shortcut_ = 'u', .flags = FL_MENU_DIVIDER, .callback_ = undo_cb, .user_data_ = 0},
  {.text = "Forced jumps rule", .shortcut_ = 'f', .flags = FL_MENU_TOGGLE | FL_MENU_VALUE, .callback_ = forced_cb, .user_data_ = 0},
  {.text = "Debug", .shortcut_ = 'd', .flags = FL_MENU_TOGGLE, .callback_ = debug_cb, .user_data_ = (void*)"d"},
  {.text = "Intelligence...", .shortcut_ = 'i', .flags = FL_MENU_DIVIDER, .callback_ = intel_cb, .user_data_ = 0},
