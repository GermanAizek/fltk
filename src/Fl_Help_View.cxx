...
public:
  ...
  value_(nullptr), topline_(0), leftline_(0), size_(0), hsize_(0),
  defcolor_(FL_FOREGROUND_COLOR), bgcolor_(FL_BACKGROUND_COLOR),
  textcolor_(FL_FOREGROUND_COLOR), linkcolor_(FL_SELECTION_COLOR),
  textfont_(FL_TIMES), textsize_(12),
  selection_mode_(Mode::DRAW), selected_(false),
  selection_first_(0), selection_last_(0),
  tmp_selection_color_(0), selection_text_color_(0),
  link_((Fl_Help_Func*)0), scrollbar_size_(0)
  {
    title_[0] = '\0';
    blocks_.clear();
    link_list_.clear();
